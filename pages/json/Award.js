export const Awards = [
	{
		...
		year: "2021",
		description:
			"Get position 2nd in KKSI Smart School Field 2021 with the theme of Smart Agriculture. Making web app using Laravel And Bootstrap, the app is about School management, it contains landing pages, student management, library management, etc",
	},
	{
		title: "3rd Position SAKKSI Smart School Field 2021",
		year: "2021",
		description:
			"Get position 3rd in SAKKSI Smart School Field 2021 with the theme of Smart Agriculture. we add some feature from KKSI app, and we make it more better, we add some feature like employee management, improving landing pages, todo app, etc.",
	},
	{
